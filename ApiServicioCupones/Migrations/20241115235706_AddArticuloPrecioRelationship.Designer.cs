...
namespace ApiServicioCupones.Migrations
{
    ...
    [Migration("20241115235706_AddArticuloPrecioRelationship")]
    partial class AddArticuloPrecioRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArticuloModel", b =>
                {
                    b.Property<int>("Id_Articulo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrecioModel", b =>
                {
            ...
            modelBuilder.Entity("PrecioModel", b =>
                {
                    b.HasOne("ArticuloModel", "Articulo")
                        .WithOne("Precio")
                        .HasForeignKey("PrecioModel", "Id_Articulo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
